...
class Blockchain {
   ...
   * @param {any} value
   */
  addDataToLevelDB(block) {  // REVIEW: block already has height when called from addNewBlock
    return this.db.put(block.height, JSON.stringify(block))
  ...
  addNewBlock(newBlock){
    return this.getNextBlockHeight().then(height => {
